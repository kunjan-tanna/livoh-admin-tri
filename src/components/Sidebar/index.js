			...
			<Fragment>
				...
				>
					<div className={classNames("rct-sidebar-content", { "sidebar-overlay-dark": isDarkSidenav, 'sidebar-overlay-light': !isDarkSidenav })}>
						<div className="site-logo justify-content-center" style={{backgroundColor: '#0E0833'}}>
							<Link to="/" className="logo-mini">
								<img src={require('Assets/img/logo.svg')} className="mr-15" alt="site logo" width="110" height="55" />
							</Link>
						...
						<div className="rct-sidebar-wrap">
							<Scrollbars
								...
								style={{ height: 'calc(100vh - 60px)', backgroundColor: '#0E0833' }}
							>
								{!agencySidebar ?
									<SidebarContent />
									:
